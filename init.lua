...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'prisma', 'vue', 'css' },
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>rl', function() vim.cmd(':LspRestart') end, '[R]estart [L]SP')
...
require('which-key').register {
  ...
  ['<leader>d'] = { name = '[D]ocument and [D]iagnostics', _ = 'which_key_ignore' },
